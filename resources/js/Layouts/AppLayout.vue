            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :active="route().current('')">
                                    Stuff
                                </jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link :active="route().current('')">
                            Stuff
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                      ...
                      <template v-else>
                        <jet-responsive-nav-link :href="route('login')" class="text-sm text-gray-700 underline">
                            Log in
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :href="route('register')" class="text-sm text-gray-700 underline">
                            Register
                        </jet-responsive-nav-link>
                      </template>
                    </div>
